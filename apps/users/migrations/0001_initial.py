    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_user', models.CharField(choices=[('AM', 'Artista / Manager'), ('GE', 'General'), ('R', 'Relator'), ('GES', 'Gestión'), ('PRO', 'Proveedor'), ('RE', 'Representante'), ('PRO', 'Profesional asociado')], default='GE', max_length=4)),
