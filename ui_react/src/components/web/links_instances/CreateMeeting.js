...
import {Button, Tooltip, Form, Drawer, Select, TimePicker, message,Row, Typography, Input} from "antd"
            ...
            >
                ...
                <Form layout={'inline'} form={form} title={'asdas'} onFinish={onFinish} >
                    <Form.Item name='day' rules={[{required:true, message:'Debes seleccionar un día'}]} >
                        <Select size={'large'} style={{width:'280px'}} placeholder={'Selecciona el día de la reunión'}>
                    ...
                    <Form.Item name='hour_minutes' rules={[{required:true, message:'Debes seleccionar la hora'}]} >
                        <TimePicker
                            ...
                            showNow={false} style={{width:'320px'}} placeholder={'Selecciona la hora(formato 24 hrs)'} format={'HH:mm'} />
                    </Form.Item>
                    ...
                    <Form.Item>
                        <Button size={'large'} type={'primary'} htmlType={'submit'} >AGENDAR</Button>
                    </Form.Item>
                    <Form.Item>
