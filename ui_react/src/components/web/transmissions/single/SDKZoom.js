...
const joinMeeting = (signature, meetConfig, state) => {
  ...
  ZoomMtg.showInviteFunction({
    ...
    ZoomMtg.init({
      leaveUrl: 'http://localhost:3000/profile',
...
const SDKZoom = ({transmission, user}) => {
  
  var first_name = user.first_name
  var last_name = user.last_name
  console.log(`${first_name} ${last_name}`)
  const meetConfig = {
      apiKey: 'djThuYQmTvaT0nGyQJm2jQ',
      apiSecret: 'GUPtWxIsBtkDWHizj9Ithg4rwDYy66k6gzN9',
